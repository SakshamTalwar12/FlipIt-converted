...
function Hard() {
  ...
  // Game state
  const [triesLeft, setTriesLeft] = useState(4); // Hard mode has 4 tries
  ...
  const [cards, setCards] = useState([
    ...
    { id: 9, img: "./images/beach.jpg", alt: "Beach", flipped: false, matched: false },
    { id: 10, img: "./images/beach.jpg", alt: "Beach", flipped: false, matched: false }
  ]);
  ...
  useEffect(() => {
    if (matchedPairs === 5) { // Hard mode has 5 pairs
      handleWin();
    }
  }, [matchedPairs]);
  ...
  return (
    <>
      ...
      <div className="difficulty-container">Difficulty: <span id="hard">Hard</span></div>
